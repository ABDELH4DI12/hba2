...
export default function InterventionsMediasPage() {
  return (
    <div className="min-h-screen">
      <SEO
        title="Interventions médias - Hicham Alaoui Bensaïd - HBA Consulting"
        description="Découvrez les interventions de Hicham BENSAID ALAOUI dans les médias, où il partage son expertise sur les enjeux économiques, financiers et stratégiques du Maroc."
        keywords="HBA médias, Hicham BENSAID ALAOUI, HBA consulting interventions, interventions médias, expert financier maroc, analyse économique maroc, HBA consulting médias"
        canonical="/interventions-medias"
      />
      <Header />
      <Breadcrumb />
